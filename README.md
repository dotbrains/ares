...
container integration, release config checks, and the Bun-backed website
typecheck/build. The repository also includes a pre-commit hook that runs the
same target before commits.
